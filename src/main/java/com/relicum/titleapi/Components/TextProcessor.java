...
/**
 * Text processor contains various helper functions for string processing including colorizing and color striping.
 */
public class TextProcessor {
     ...
     * <p>This is only a short cut method as the same result can be achieved using {@link com.relicum.titleapi.Components.TextProcessor#colorize(String, String, String)} .
     * <p>This will replace all valid matches in the entire string passed to it.
     *
